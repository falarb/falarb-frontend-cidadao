...
export default function Step006({
  ...
  return (
    <div className="container-step-4">
      ...
      <small
        title="Informação importante: você só precisará preencher esses dados uma única vez."
      >
      ...
      <InputText
        ...
        title="Digite aqui seu nome completo conforme documentos oficiais"
      />
      ...
      <InputCustomMask
        ...
        required={true}
        title="Digite seu CPF para validação de identidade"
      />
      ...
      <InputCustomMask
        ...
        title="Digite seu número de celular com DDD para contato"
      />

      <BtnPrimary
        disabled={handleDisableBtn()}
        onClick={() => { cadastrarCidadao() }}
        title="Avançar para o próximo passo após preencher corretamente os campos obrigatórios"
      >
        Próximo passo
      </BtnPrimary>
      ...
      <BtnSecundary
        ...
        title="Cancelar o processo atual e retornar à tela inicial"
      >
      ...
      <HelpIndicator
        onHelpOpen={openHelp}
        isOpen={!isHelpOpen}
        title="Clique para abrir as instruções de ajuda desta etapa"
      />
