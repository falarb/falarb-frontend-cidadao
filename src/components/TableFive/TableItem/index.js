...
export default function TableItem({ height, id, link_view, status, col1, col2, col3, col4, col5, tipo, onClickView, onClickEdit, onClickDelete, classNameCol5}) {
    ...
    return (
        <div className={`table-item ${height}`}>
            ...
            <div className={`table-item-status ${status}`} to="/"></div>
                ...
                <div className={`table-item-column${classNameCol5} status-${classNameCol5}`}>
